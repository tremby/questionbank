...
<head>
	...
	<script type="text/javascript">
		qtitinymceoptions = {
			...
			theme: "advanced",
			plugins: "safari,table,iespell,inlinepopups,media,contextmenu,paste,xhtmlxtras,template",
			...
			theme_advanced_buttons4: "undo,redo,|,hr,charmap,image,media,template,|,iespell,removeformat,cleanup,code",
			...
			valid_elements: "@[id|class|lang|label],"
				...
				+ "object[!data|!type|width|height],param[!name|!value],"
				+ "col[span],colgroup,"
				+ "dfn,kbd,"
				+ "q[cite],samp,small,"
				+ "tt,var,big",
